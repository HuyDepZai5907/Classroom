        ...
        function send_activation_email($email,$token){
            ...
            try {
                ...
                */
                ...
                $mail->Body    = "Click <a href='classroomdemo.herokuapp.com/Activate.php?email=$email&token=$token'>vào đây</a> để xác minh tài khoản của bạn";
        ...
        function send_invite_email($sender,$email,$user,$classID,$token,$className,$role){
            ...
            try {
                ...
                */
                ...
                $mail->Body    = "Bạn được mời tham gia vào lớp học <a href='classroomdemo.herokuapp.com/AcceptInvite.php?user=$user&classID=$classID&token=$token'>$className</a> với vai trò $role";
                //$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
